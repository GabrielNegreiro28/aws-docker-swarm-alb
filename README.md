...
### Docker Swarm Nodes
![Docker Swarm Nodes](screenshots/docker-node-ls.jpeg)

### Running Services
![Docker Services](screenshots/docker-service-ps.jpeg)

### Load Balancer Target Health
![ALB Targets](screenshots/alb-targets-healthy.jpeg)

### Application Access via ALB
![NGINX via ALB](screenshots/nginx-alb.jpeg)
